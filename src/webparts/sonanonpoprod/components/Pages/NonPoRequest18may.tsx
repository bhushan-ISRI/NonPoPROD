...
const hasValidExtension = (fileName: string) =>
  ...
  const createNew = async (values: INonPoFormValues) => {
    ...
    approvalList.push({
      ...
      UserID: await getCurrentUserId(sp!),
    ...
    approvalList.push({
      ...
      UserID: hodUser?.Id || null,
      UserEmail: reqDefaults.HODEmail,
      PendingText: "Pending At HOD"
    });

    // CFO + Performer from master
    const matrixRows = await loadApprovalRoles(sp!);
    matrixRows.forEach(m => approvalList.push(m));
   ...
   //   Amount: (values.Amount || "").toString(),
      ...
      CurrentApproverId: rmUser?.Id || null,
    ...
    for (let i = 0; i < MAX_RETRIES; i++) {
      ...
      try {
        await list.items.getById(itemId).update({ Title: newTitle });
        setOk = true;
        break;
      } catch (e: any) {
                    ...
                    <div className='main-formcontainer'>
                      ...
                      <div className='row mb-20'>
                        ...
                        <div className='col-md-4 alignbox'>
                          ...
                          <Field readOnly name="Division" className="fonttext" />
                        </div>
                      </div>
                      <div className='row mb-20'>
                        <div className='col-md-4 alignbox'>
                    ...
                    <div className='main-formcontainer'>
                      <div className='row mb-20'>
                        <div className='col-md-4'>
                          ...
                          <select
                            className={`form-select ${touched.VendorCode && errors.VendorCode ? "is-invalid" : ""}`}
                        ...
                        <div className='col-md-4'>
                          ...
                          <Field name="VendorName" className="form-control readonly" placeholder="Auto from Vendor" />
                        </div>
                        <div className='col-md-4'>
                              ...
                              <div className="table-responsive">
                                <table className="table table-sm table-bordered mb-0">
                                  <thead className="table-light">
                                    <tr><th>File</th><th style={{ width: 140 }}>Size</th><th style={{ width: 90 }}>Action</th></tr>
                                  </thead>
                                  <tbody>
                      ...
                      <div className="row mb-20">
                        <div className="col-md-12">
                          {loadingExisting ? (
                            ...
                            <div className="text-secondary">No documents available.</div>
                          ) : (
                            <div className="table-responsive">
                              <table className="table table-sm table-bordered mb-0">
                                <thead className="table-light">
...
>
  {formikRef.current?.isSubmitting ? "Submitting..." : (isNew ? "Submit" : "Save")}
                          ...
                          <a onClick={() => navigate("/InitiatorLanding")} className="Exit-btn">
                            Exit
                          </a>
                        </div>
                      </div>
