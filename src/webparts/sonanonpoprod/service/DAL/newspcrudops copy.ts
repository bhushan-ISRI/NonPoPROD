...
export interface INEWSPCRUDOPS {
...
class SPCRUDOPSImpl implements INEWSPCRUDOPS {
    private sp;
...
// ✅ Factory function
export default function NEWSPCRUDOPS(props: ISonanonpoprodProps): INEWSPCRUDOPS {
